...
export default function Process() {
  ...
  return (
    <>
      <div className="flex justify-center items-center lg:mx-10 overflow-hidden">
        <div className="grid md:grid-row-2">
          <div className="flex flex-col items-center">
            <div className="flex gap-2 lg:ml-5">
              <h1 className="sm:text-4xl text-2xl">Our</h1>
              <SparklesText text="Creative" />
              <h1 className="sm:text-4xl text-2xl">Process</h1>
            </div>
            <div className="flex justify-center">
              <p className="text-gray-500 dark:text-white sm:text-base text-sm lg:ml-3 text-center px-5 mt-2">
                All of our services are designed to make your business stand out
              </p>
            </div>
          </div>

          <div className="grid md:grid-cols-2 items-center md:gap-10 md:mt-10 z-0">
            <div
              className={cn(
                "relative flex h-auto max-w-full items-center justify-center overflow-hidden rounded-lg bg-background p-10  "
              )}
              ref={containerRef}
            >
            ...
            <div className="lg:ml-10">
              ...
              <p className="text-gray-500 dark:text-white my-4">
                Connect with us via meeting
              </p>
              <BoxReveal boxColor={"#5046e6"} duration={0.5}>
                <h1 className="font-bold text-[24px]">2. Collaborate</h1>
              </BoxReveal>
              <p className="text-gray-500 dark:text-white my-4">
                Outline the scope of the project
              </p>
              <BoxReveal boxColor={"#5046e6"} duration={0.5}>
                <h1 className="font-bold text-[24px]">3. Create</h1>
              </BoxReveal>
              <p className="text-gray-500 dark:text-white my-4">
